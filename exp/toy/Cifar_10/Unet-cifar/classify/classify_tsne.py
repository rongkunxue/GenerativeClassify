...
# Initialize wandb
wandb.init(project="cifar10_classification_3")
...
optimizers = {
    "origin": optim.SGD(models["origin"].parameters(), lr=0.001, momentum=0.9),
    # "combine": optim.SGD(models["combine"].parameters(), lr=0.001, momentum=0.9),
    "transform": optim.SGD(models["transform"].parameters(), lr=0.001, momentum=0.9),
}
