    ...
    config = EasyDict(
        dict(
            ...
            parameter=dict(
                ...
                accelerate_checkpoint_path="/root/Github/generativeencoder/exp/toy/Tiny_image_128/data",
                video_save_path="/root/Github/generativeencoder/exp/toy/Tiny_image_128/video",
                device=device,
            ),
        )
    )
