...
def build_scheduler(config, optimizer, n_iter_per_epoch):
    num_steps = int(config.TRAIN.iteration * n_iter_per_epoch)
    warmup_steps = int(config.TRAIN.warmup_iteration * n_iter_per_epoch)
    decay_steps = int(config.TRAIN.decay_iteration * n_iter_per_epoch)
